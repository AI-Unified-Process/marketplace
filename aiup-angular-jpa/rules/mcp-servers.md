...
Hibernate or for Angular specifically — a dedicated server following that same pattern
would be a natural addition here, but isn't included today rather than pointing at a
